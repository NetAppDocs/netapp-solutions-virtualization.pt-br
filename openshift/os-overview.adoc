...
. Siga as link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.22#Install["instruções de instalação"] instruções fornecidas pela Red Hat para implantar no ambiente de sua escolha.
