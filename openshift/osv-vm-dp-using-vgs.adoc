...
.Passos
. Instale o OpenShift Cluster versão 4.19 seguindo as instruções na documentação da Red Hat: https://docs.redhat.com/en/documentation/openshift_container_platform/4.19#Install["Instalando o OpenShift Container Platform"].
