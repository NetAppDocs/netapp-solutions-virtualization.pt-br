...
[role="lead"]
Assista a vídeos e demonstrações que mostram a integração do VMware com as soluções de armazenamento da NetApp . Veja como usar o NetApp ONTAP Tools para VMware vSphere, o SnapCenter Plug-in for VMware vSphere, a proteção de dados 3-2-1 e como o NetApp funciona com o VMware Cloud Foundation e o VMware vSphere Foundation.
...
.Proteção de dados 3-2-1 para datastores VMFS com o SnapCenter Plug-in for VMware vSphere e NetApp Backup and Recovery para máquinas virtuais.
...
.VKS com Supervisor em Virtual Distributed Switch
video::4ef64b3c-7a68-41d5-bacf-b4a8012b49f8[panopto,width=360]
.VKS com automação VCF
