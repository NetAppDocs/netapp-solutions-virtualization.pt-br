...
NOTE: A configuração desejada para dispositivos ONTAP multipath já está incluída no pacote. Para mais informações, consulte o link:https://docs.netapp.com/us-en/ontap-sanhost/hu-proxmox-ve-9x.html#step-1-confirm-the-multipath-configuration-for-your-host["Documentação do ONTAP 9 no Proxmox VE 9.x para FCP e iSCSI com armazenamento ONTAP"]
