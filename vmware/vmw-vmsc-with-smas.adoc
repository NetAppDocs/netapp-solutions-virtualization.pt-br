...
. Atualize os dados dos hosts para sincronizar com o ONTAP Tools e então,link:https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/configure/create-vvols-datastore.html#create-a-vmfs-datastore["criar um armazenamento de dados"] .image:vmware-vmsc-with-smas-017.png["Atualizar dados de hosts"]
