...
summary: 'Comece a adicionar NFS e vVols como armazenamento suplementar aos domínios de carga de trabalho do VCF usando as ONTAP tools for VMware vSphere. Você vai implantar as ONTAP tools for VMware vSphere, configurar uma Storage Virtual Machine (SVM) com interfaces lógicas NFS e provisionar datastores NFS e vVols.' 
---
= Fluxo de trabalho de implantação para adicionar datastores NFS vVols como armazenamento suplementar em um domínio de carga de trabalho VCF
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Comece a adicionar datastores NFS vVols como armazenamento suplementar em um domínio de carga de trabalho VCF usando as ONTAP tools for VMware vSphere. Você revisará os requisitos de implantação, implantará as ONTAP tools for VMware vSphere, configurará a SVM com interfaces lógicas e configurará o armazenamento.
...
[role="quick-margin-para"]
Configure a rede para NFS nos hosts vSphere.
