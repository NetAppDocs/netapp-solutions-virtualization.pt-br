...
[%collapsible%open]
====
As soluções de proteção de dados 3-2-1 combinam backups primários e secundários locais, usando a tecnologia SnapMirror , com cópias replicadas para armazenamento de objetos usando o NetApp Backup and Recovery.
