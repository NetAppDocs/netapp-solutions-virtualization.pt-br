---
sidebar: sidebar 
permalink: vmware/vmw-vcf-mgmt-vmfs-deploy.html 
...
summary: Implante as ONTAP tools for VMware vSphere 10 e provisione um datastore VMFS para permitir a integração perfeita com o VMware Cloud Foundation. Você vai implantar as ONTAP tools, configurar os backends de storage e criar um datastore VMFS para suportar a convergência de um cluster vSphere para um domínio de gerenciamento do VCF. 
---
= Implemente as ONTAP tools e provisione o datastore VMFS para a convergência do domínio de gerenciamento do VCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Implante o ONTAP tools for VMware vSphere 10 e provisione um datastore VMFS compatível para permitir a integração perfeita com o VMware Cloud Foundation. Você implantará o ONTAP tools for VMware vSphere, configurará os backends de storage e criará um datastore VMFS para suportar a convergência de um cluster vSphere para um domínio de gerenciamento do VCF.
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-001.png[Implantar modelo OVF]
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-002.png[configuração - tipo de implantação]
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-003.png[Personalizar modelo]
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-004.png[ferramentas ONTAP abertas]
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-005.png[Adicionar backend de armazenamento]
...
[[step-3-provision-the-vmfs-datastore-with-ontap-tools]]
== Etapa 3: Provisione o datastore VMFS com as ONTAP tools

As ONTAP tools integram funcionalidades em toda a interface do usuário do cliente vSphere. Nesta etapa, um datastore VMFS é provisionado a partir da página de inventário dos hosts.
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-006.png[Criar armazenamento de dados]
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-007.png[Tipo de armazenamento de dados]

====
. Na página *Nome e Protocolo*, insira o nome do datastore, o tamanho e o protocolo desejado a ser utilizado.
+
.Mostrar exemplo
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-008.png[Nome e protocolo]
...
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-009.png[Página de armazenamento]
...
+
As ONTAP tools criarão um volume no sistema de storage ONTAP e o montarão como um datastore VMFS em todos os hosts vSphere do cluster.

+
.Mostrar exemplo
[%collapsible]
====
image::vmw-vcf-mgmt-vmfs-deploy-010.png[Página de resumo]
...
Após implantar o ONTAP tools for VMware vSphere e provisionar o datastore VMFS, link:vmw-vcf-mgmt-vmfs-converge.html["Convergir o vSphere cluster para um domínio de gerenciamento VCF"].
