...
summary: Configure o armazenamento iSCSI vVols em um domínio de carga de trabalho usando as ONTAP tools. Você implantará as ONTAP tools for VMware vSphere, registrará um sistema de storage, criará um perfil de capacidade de armazenamento e provisionará um datastore vVols no cliente vSphere. 
---
= Configurar o armazenamento iSCSI vVols em um domínio de carga de trabalho VCF usando o ONTAP tools
:allow-uri-read: 




[[configure-iscsi-vvols-storage-in-a-vcf-workload-domain-using-ontap-tools]]
== Configurar o armazenamento iSCSI vVols em um domínio de carga de trabalho VCF usando o ONTAP tools

[role="lead"]
Configure o armazenamento iSCSI vVols em um domínio de carga de trabalho usando as ONTAP tools. Você implantará as ONTAP tools for VMware vSphere, registrará um sistema de storage, criará um perfil de capacidade de armazenamento e provisionará um datastore vVols no cliente vSphere.
...
Para domínios de carga de trabalho, o ONTAP tools é instalado no cluster de gerenciamento VCF, mas registrado no vCenter associado ao domínio de carga de trabalho.
