...
[role="lead"]
Implante, integre, importe ou atualize ambientes do VMware Cloud Foundation 9 com o ONTAP. Saiba como configurar novos ambientes VCF 9.1, integrar instâncias vCenter existentes como Management Domain ou importar instâncias vCenter existentes como Workload Domain, e atualizar implantações VCF anteriores.

Para mais detalhes, consulte a link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-1/deployment/overview-of-deploy--converge--and-upgrade.html["Link da Broadcom para caminhos de implantação do VCF 9.1"].
...
Use este fluxo de trabalho para implantar um ambiente VMware Cloud Foundation (VCF) 9.1 limpo. Após a implantação, você pode migrar cargas de trabalho ou começar a provisionar aplicativos e fornecer serviços de infraestrutura.

.Passos
. Siga o link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-1/deployment/deploying-a-new-vmware-cloud-foundation-or-vmware-vsphere-foundation-private-cloud-/preparing-your-environment.html["Etapas de implantação do Broadcom VCF 9"].
...
. Implante o ONTAP NFS VAAI VIB e utilize esse servidor para a imagem do cluster. Por exemplo: `esxcli software vib install -d /NetAppNasPlugin2.0.1.zip`. (Baixe o arquivo ZIP do site de suporte da NetApp.)
...
--
====
. Após a implantação bem-sucedida da link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-1/deployment/deploying-a-new-vmware-cloud-foundation-or-vmware-vsphere-foundation-private-cloud-/deploy-a-new-vcf-fleet-or-a-new-vcf-instance.html["O VCF Fleet"] fase, conclua o seguinte:
+
...
+
*** link:https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-vmware-protect-overview.html["Proteja cargas de trabalho VM"].
...
.Passos
. Consulte o link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-1/deployment/converging-your-existing-vsphere-infrastructure-to-a-vcf-or-vvf-platform-/supported-scenarios-to-converge-to-vcf.html["cenários suportados para convergir para VCF"].
...
Atualize uma implementação anterior do VCF para a versão 9.1 usando o processo de atualização padrão. O resultado é um ambiente VCF executando a versão 9.1 com domínios de gerenciamento e de carga de trabalho atualizados.

.Pré-requisitos
* Faça backup do domínio de gerenciamento e dos domínios de carga de trabalho.
* Verifique a compatibilidade das ferramentas ONTAP e do SnapCenter Plug-in com o VCF 9.1. Siga as link:https://imt.netapp.com/imt/#welcome["Matriz de Interoperabilidade"] instruções para link:https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/upgrade/upgrade-ontap-tools.html["atualizar ferramentas ONTAP"] e link:https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/scpivs44_upgrade.html["Plug-in SnapCenter para VMware vSphere"] que são compatíveis com o VCF 9.1.


.Passos
. Atualize o domínio de gerenciamento do VCF. Consulte link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-1/deployment/upgrading-cloud-foundation.html["Atualize o domínio de gerenciamento do VCF para o VCF 9.1"] para obter instruções.
. Atualize todos os domínios de carga de trabalho do VCF 5.x. Consulte link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf/vcf-9-0-and-later/9-1/lifecycle-management/upgrade-workload-domains-to-vcf-5-2.html["Atualizar o domínio de carga de trabalho do VCF 5.x para o VCF 9.1"] para obter instruções.
