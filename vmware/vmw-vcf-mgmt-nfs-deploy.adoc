...
summary: Implemente as ONTAP tools for VMware vSphere 10 e provisione um datastore NFS para permitir a integração perfeita com o VMware Cloud Foundation. Você vai implementar as ONTAP tools, configurar os backends de storage e criar um datastore NFS para dar suporte à convergência de um vCenter para um domínio de gerenciamento do VCF. 
---
= Implantar as ONTAP tools e provisionar o datastore NFS para o domínio de gerenciamento VCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Implemente as ONTAP tools for VMware vSphere 10 e provisione um datastore NFS para permitir a integração perfeita com o VMware Cloud Foundation. Você vai implementar as ONTAP tools, configurar os backends de storage e criar um datastore NFS para dar suporte à convergência de um vCenter para um domínio de gerenciamento do VCF.
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-001.png[Implantar modelo OVF]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-002.png[configuração - tipo de implantação]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-003.png[Personalizar modelo]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-004.png[ferramentas ONTAP abertas]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-005.png[Adicionar backend de armazenamento]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-006.png[Criar armazenamento de dados]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-007.png[Nome e protocolo]
...
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-008.png[Página de armazenamento]
...
+
As ONTAP tools criam um volume no sistema de storage ONTAP e o montam como um datastore NFS em todos os hosts vSphere do cluster.

+
.Mostrar exemplo
[%collapsible]
====
image::vmw-vcf-mgmt-nfs-deploy-009.png[Página de resumo]
...
Depois de implantar as ONTAP tools e provisionar o datastore NFS, link:vmw-vcf-mgmt-nfs-converge.html["convergir o vSphere cluster para o domínio de gerenciamento de VCF"].
