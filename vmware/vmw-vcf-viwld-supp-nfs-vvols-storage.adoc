...
summary: Configure o armazenamento NFS vVols em um domínio de carga de trabalho. Após implantar o ONTAP tools for VMware vSphere, você usará a interface do cliente vSphere para adicionar o sistema de storage, criar um perfil de capacidade de armazenamento e provisionar um datastore vVols. 
---
= Configurar o armazenamento NFS vVols em um domínio de carga de trabalho VCF usando o ONTAP tools
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Configure o armazenamento NFS vVols em um domínio de carga de trabalho. Após implantar o ONTAP tools for VMware vSphere, você usará a interface do cliente vSphere para adicionar o sistema de storage, criar um perfil de capacidade de armazenamento e provisionar um datastore vVols.
