...
|===
| Protocolo de Armazenamento | diretório | fs | netfs | lógico | disco | iscsi | iscsi-direto 


| mpath | PME/CIFS | Sim | Não | Sim | Não | Não | Não 


| Não | Não | NFS | Sim | Não | Sim | Não | Não 


| Não | Não | Não | iSCSI | Sim | Sim | Não | Sim 


| Sim | Sim | Sim | Sim | FC | Sim | Sim | Não 


| Sim | Sim | Não | Não | Sim | NVMe-oF | Sim | Sim 
|===
