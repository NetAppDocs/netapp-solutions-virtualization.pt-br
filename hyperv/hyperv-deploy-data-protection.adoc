...
[[backup-and-restore-using-third-party-solutions]]
...
Para obter instruções detalhadas sobre como configurar o array, consulte link:https://documentation.commvault.com/v11/commcell-console/configuring_netapp_array_using_array_management.html["Configurando o NetApp Array"] e link:https://documentation.commvault.com/v11/commcell-console/configure_storage_virtual_machine_on_netapp_storage_array.html["Configurando máquinas virtuais de armazenamento em matrizes NetApp"]
