...
* Os VMDKs podem ser configurados de várias maneiras: todos os VMDKs podem residir em um único volume (eliminando a necessidade de Storage vMotion), cada VMDK pode ser colocado em seu próprio volume individual ou vários VMDKs podem ser organizados em uma qtree dentro de um volume.
+

NOTE: O kit de ferramentas Shift detecta automaticamente o layout e seleciona o método de clonagem e os drivers de armazenamento NAS apropriados.
