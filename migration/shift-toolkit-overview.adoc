...
O kit de ferramentas Shift pode ser baixado.link:https://mysupport.netapp.com/site/tools/tool-eula/vm-data-collector["aqui"] e está disponível apenas para sistemas Windows.
